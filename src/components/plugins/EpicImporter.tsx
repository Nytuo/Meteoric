              ...
              {authStep === 0 && (
                <div className="space-y-4">
                  <p className="text-sm text-muted-foreground">
                    {t('epic-importer.howto') ||
                      'Sign in to your Epic Games account to get an authorization code.'}
                  </p>
        ...
        <div className="flex flex-1 flex-col space-y-3 overflow-hidden">
          ...
          {!loggedIn && (
            <p className="text-sm text-amber-600 dark:text-amber-400">
              ...
              {t('pleaseLoginFirst') ||
                'Please login first to see your Epic library.'}
            </p>
          )}
            ...
            <div className="space-y-1 pr-3">
              {downloadableGames.map((game) => {
                const localGame = games.find((g) => {
                  ...
                  return (
                    g.importer_id === 'epic' && epicData?.[1] === game.app_name
                  );
                });
                ...
                >
                  ...
                  <div className="flex gap-1">
                    <Button
                      size="sm"
                      variant="ghost"
                      onClick={() => launchGame(game.app_name)}
                    >
                    ...
                    <Button
                      size="sm"
                      variant="ghost"
                      onClick={() => uninstallGame(game.app_name)}
                    >
