...
export class TopbarComponent implements OnInit {
    ...
    sorts: any[] = [
        ...
        {name: this.translate.instant('last-played'), value: 'last_time_played'},
    ...
    addCategory() {
        ...
        this.categoryService.createCategory(
            ...
            'bookmark',
            [this.gameID],
            [this.translate.instant('category.all'), this.translate.instant('installed'), this.translate.instant('not-installed')],
            [this.translate.instant('view.grid'), this.translate.instant('view.list')],
            '',
        );
                ...
                if (val.url.includes('game') && !val.url.includes('games')) {
                    ...
                    if (id) {
                        ...
                        this.displayPlayForGame =
                            game?.exec_file && game?.game_dir ? this.translate.instant('play')
