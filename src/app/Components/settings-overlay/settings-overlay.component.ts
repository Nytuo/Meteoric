...
export class SettingsOverlayComponent implements OnInit {
    ...
    themes: any[] = [
        ...
        {label: 'Bootstrap4 Light Purple', value: 'bootstrap4-light-purple.css'},
        {label: 'Bootstrap4 Dark Blue', value: 'bootstrap4-dark-blue.css'},
        {label: 'Bootstrap4 Dark Purple', value: 'bootstrap4-dark-purple.css'},
    ...
    changeTheme() {
        let themeLinker = document.getElementById('themeLinker') as HTMLLinkElement;
    ...
    ngOnInit(): void {
        this.selectedTheme = (document.getElementById('themeLinker') as HTMLLinkElement).href.split('/').pop();
